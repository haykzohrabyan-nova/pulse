 ...
 * Rewritten per PUL-296: per-competitor spec-aware scoring + transparency data.
 *
 * lookupBenchmark() now scores each data row independently per competitor
 ...
 * staleness tiers, and a derived competitor capabilities view.
 *
 * Usage:
...
// ─── Inline dataset ─────────────────────────────────────────────────────────
// Normalized schema per PUL-296:
//   qid, pt, comp, size, qty, mat,
//   finish ('matte'|'gloss'|'uncoated'|null),
...
//
// Existing rows: finish inferred from qid/mat where unambiguous.
// lam, uv, foil, shape remain null — not backfilled per Q1 decision.
// New captures (PUL-288+) will target all finishing fields explicitly.

const BENCHMARK_ROWS = [
  // Roll Labels ─────────────────────────────────────────────────────────────
  {qid:"3x3-5000-matte-bopp-cmyk",pt:"roll_labels",comp:"gotprint",  size:"3x3",  qty:5000, mat:"White BOPP",      finish:"matte",lam:null,uv:null,foil:null,shape:null,price:356.80, uPrice:0.07136,conf:"high",  cap:"2026-04-17"},
  ...
  {qid:"3x3-1000-matte-bopp-cmyk",pt:"roll_labels",comp:"gotprint",  size:"3x3",  qty:1000, mat:"White BOPP",      finish:"matte",lam:null,uv:null,foil:null,shape:null,price:148.91, uPrice:0.14891,conf:"high",  cap:"2026-04-17"},
  ...
  {qid:"4x2-10000-matte-bopp-cmyk",pt:"roll_labels",comp:"uprinting",size:"4x2",  qty:10000,mat:"White BOPP",      finish:"matte",lam:null,uv:null,foil:null,shape:null,price:683.03, uPrice:0.0683, conf:"high",  cap:"2026-04-17"},
  ...
  {qid:"up-2x3-1000-matte-bopp",   pt:"roll_labels",comp:"uprinting",size:"2x3",  qty:1000, mat:"White BOPP",      finish:"matte",lam:null,uv:null,foil:null,shape:null,price:95.87,  uPrice:0.09587,conf:"high",  cap:"2026-04-17"},
  {qid:"up-2x3-5000-matte-bopp",   pt:"roll_labels",comp:"uprinting",size:"2x3",  qty:5000, mat:"White BOPP",      finish:"matte",lam:null,uv:null,foil:null,shape:null,price:204.27, uPrice:0.04085,conf:"high",  cap:"2026-04-17"},
  ...
  {qid:"axiom-2x3-250-bopp",       pt:"roll_labels",comp:"axiomprint",size:"2x3", qty:250,  mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:112.68, uPrice:0.4507, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-2x3-500-bopp",       pt:"roll_labels",comp:"axiomprint",size:"2x3", qty:500,  mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:124.76, uPrice:0.2495, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-2x3-1000-bopp",      pt:"roll_labels",comp:"axiomprint",size:"2x3", qty:1000, mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:148.32, uPrice:0.1483, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-2x3-2500-bopp",      pt:"roll_labels",comp:"axiomprint",size:"2x3", qty:2500, mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:213.27, uPrice:0.0853, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-3x4-250-bopp",       pt:"roll_labels",comp:"axiomprint",size:"3x4", qty:250,  mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:120.28, uPrice:0.4811, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-3x4-500-bopp",       pt:"roll_labels",comp:"axiomprint",size:"3x4", qty:500,  mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:139.45, uPrice:0.2789, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-3x4-1000-bopp",      pt:"roll_labels",comp:"axiomprint",size:"3x4", qty:1000, mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:176.67, uPrice:0.1767, conf:"high",  cap:"2026-04-17"},
  {qid:"axiom-3x4-2500-bopp",      pt:"roll_labels",comp:"axiomprint",size:"3x4", qty:2500, mat:"White Matte BOPP",finish:"matte",lam:null,uv:null,foil:null,shape:null,price:277.76, uPrice:0.1111, conf:"high",  cap:"2026-04-17"},
  {qid:"3x3-100-gloss-bopp-cmyk",  pt:"roll_labels",comp:"gotprint",  size:"3x3", qty:100,  mat:"White BOPP",      finish:"gloss",lam:null,uv:null,foil:null,shape:null,price:76.28,  uPrice:0.7628, conf:"high",  cap:"2026-04-17"},
  {qid:"3x3-250-gloss-bopp-cmyk",  pt:"roll_labels",comp:"gotprint",  size:"3x3", qty:250,  mat:"White BOPP",      finish:"gloss",lam:null,uv:null,foil:null,shape:null,price:86.16,  uPrice:0.34464,conf:"high",  cap:"2026-04-17"},
  {qid:"3x3-500-gloss-bopp-cmyk",  pt:"roll_labels",comp:"gotprint",  size:"3x3", qty:500,  mat:"White BOPP",      finish:"gloss",lam:null,uv:null,foil:null,shape:null,price:123.00, uPrice:0.246,  conf:"high",  cap:"2026-04-17"},
  {qid:"3x3-2500-gloss-bopp-cmyk", pt:"roll_labels",comp:"gotprint",  size:"3x3", qty:2500, mat:"White BOPP",      finish:"gloss",lam:null,uv:null,foil:null,shape:null,price:226.86, uPrice:0.09074,conf:"high",  cap:"2026-04-17"},
  {qid:"3x3-10000-gloss-bopp-cmyk",pt:"roll_labels",comp:"gotprint",  size:"3x3", qty:10000,mat:"White BOPP",      finish:"gloss",lam:null,uv:null,foil:null,shape:null,price:618.83, uPrice:0.06188,conf:"high",  cap:"2026-04-17"},
  // Folding Cartons ─────────────────────────────────────────────────────────
 ...
 * BOPP and paper are the primary split that matters for labels.
 */
...
function _captureAgeDays(capDate) {
  ...
  return Math.floor((new Date('2026-04-22') - new Date(capDate)) / 86400000);
}
...
function _scoreRow(row, userArea, userQty, specs) {
  ...
  score += Math.abs(Math.log2(Math.max(userQty, row.qty) / Math.min(userQty, row.qty))) * 1.5;
 ...
 * 'close'       — qty ≤ 3×, size ≤ 1.5×, only soft flags (not-captured)
 * 'approximate' — hard spec mismatch, or size/qty far off
 */
function _perCompMatchQuality(row, userArea, userQty, mismatchReasons) {
  ...
  const hardMismatches = mismatchReasons.filter(r =>
    r === 'material' || r === 'uv-not-supported' || r === 'foil-not-supported'
  );
 ...
 *
 * Old model: score per queryId group, return all competitors under the
 * best-scoring group.
 *
 * New model: each competitor independently scores all of its rows and
 * picks the single best-matching one. Returns a per-competitor result array
 * with full mismatch transparency, staleness tier, and match quality.
 *
...
function lookupBenchmark(productType, widthIn, heightIn, quantity, specs) {
  ...
  KNOWN_COMPETITORS.forEach(comp => {
    ...
    if (!compRows.length) {
      // Competitor is tracked but has no data for this product type
 ...
 * Hard mismatches (uv-not-supported, foil-not-supported, material) get red;
 * soft flags (not-captured) get amber.
 */
...
const HARD_MISMATCHES = new Set(['material', 'uv-not-supported', 'foil-not-supported']);
...
function updateBenchmarkPanel(elementId, productType, widthIn, heightIn, quantity, bazaarTotal, specs) {
  ...
  let avgRow = '';
  if (marketAvg) {
    const avgLabel = limitedData ? 'Market avg <span style="font-size:10px;color:#94a3b8;font-weight:400;">(limited data)</span>' : 'Market avg';
    avgRow = `
  ...
  // ── Staleness footer (only if any dated/stale rows) ──────────────────────
